	...
	<body>
		...
		<div class="top center">
			<div class="logo center">
				<a href="${ctx }/index.jsp" target="_self"><img src="../image/mistore_logo.png" alt=""></a>
			</div>
		</div>
		<form  method="post" action="${ctx }/user/login" class="form center">
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					<div class="username">用户名:&nbsp;<input class="shurukuang" type="text" name="name" placeholder="请输入你的用户名"/></div>

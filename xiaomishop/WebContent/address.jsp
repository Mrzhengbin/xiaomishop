		...
		<div class="lfnav fl">
			...
			<div class="subddzx">
				<ul>
					...
					<li><a href="">消息通知</a></li>
					<li><a href="">优惠券</a></li>
					<li><a href="${ctx}/address.jsp?id=${id}">收货地址</a></li>
				</ul>
			</div>
		</div>
		<div class="rtcont fr">
			<div class="ddzxbt">订单地址</div>
			<form action="${ctx}/order/address" method="GET">
				<input type="hidden" value="${id}" name ="orderid">
				请填写收货地址：<input type="text" name="address" value="${address}"/>
